...
import by.bsuir.mpp.xpulse.web.rest.errors.EmailAlreadyUsedException;
import by.bsuir.mpp.xpulse.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String login) {
        ...
        return ResponseUtil.wrapOrNotFound(
            userService.getUserWithAuthorityByLogin(login)
                .map(UserDTO::new));
    }
    ...
    public ResponseEntity<Void> deleteUsers(@RequestBody List<Long> ids) {
        log.debug("REST request to delete Users: {}", ids);
